...
export const gitImage = 'https://avatars1.githubusercontent.com/'
export const Emoji = ({ i, extra, className }) => (
  <span className={className} role="img" aria-label="img">
    {i}
    {extra}
  </span>
)

export const lorem = `Ipsum non eiusmod cillum ea exercitation aliquip reprehenderit tempor
